...
Thống nhất tách bảo trì danh mục thành menu riêng, cùng cấp với quản trị hệ thống và giám sát dữ liệu.
...
Thống nhất phân quyền theo chức năng, một màn hình dùng chung, ẩn/hiện cột và nút theo quyền.
...
Thống nhất tải hàng loạt theo khu vực riêng, tự gắn theo tên tệp; tổ chức một buổi khảo sát chuyên đề về luồng tài liệu này.
...
Thống nhất tài liệu sinh từ TOSS thì lưu, tài liệu từ hệ thống ngoài lưu tối đa ba ngày rồi xóa.
...
Thống nhất quản lý tàu bay theo hình thức sở hữu và thuê, kèm lịch sử và phân nhóm đội tàu.
...
Thống nhất xây danh mục dịch vụ sân bay phục vụ cảnh báo.
...
Thống nhất số hóa BCAO theo đúng cấu trúc hiện hành, tổng hợp tự động tối đa, phân quyền theo tab nguồn, có phê duyệt và trình bày trực quan; bất thường nhập đa chiều theo danh mục nguyên nhân, phục vụ cả báo cáo ngày và thống kê dài hạn; yếu nhân và chuyên cơ ưu tiên tự động kèm nhập tay.
...
Thống nhất tách màn giám sát dữ liệu riêng; tính tự động chỉ số và quản lý mục tiêu kèm theo.
...
Sử dụng các chuẩn quốc tế để tham khảo và giải thích, không thay thế yêu cầu thực tế của hãng.
...
*v0.2 (2026-06-12): chuẩn hóa cấu trúc §II sang Yêu cầu / Thảo luận–Đề xuất / Kết luận để đồng bộ chuẩn báo cáo khảo sát (SOP-BCKS); nội dung giữ nguyên, chỉ tái cấu trúc.*
