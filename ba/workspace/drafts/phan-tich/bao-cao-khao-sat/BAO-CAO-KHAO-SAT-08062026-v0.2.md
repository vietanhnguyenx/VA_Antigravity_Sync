...
Thống nhất khảo sát song song, làm tổng quan trước; VTIT gửi công văn và bộ câu hỏi trước mỗi đợt.
...
Thống nhất tách màn hình giám sát riêng cho hai nhóm đối tượng.
...
Thống nhất mục tiêu thay thế FMS; cơ chế cập nhật dữ liệu chưa chốt, cần khảo sát thêm.
...
Ưu tiên báo cáo hàng ngày; phát hành qua thư điện tử, không ký số.
...
Thống nhất giữ nguyên quy trình bốn bước, làm rõ chi tiết ở buổi sau.
...
Cần kiểm chứng lại nguồn dữ liệu hành khách trước khi dùng để ra quyết định.
...
Phối hợp xử lý việc cấp hạ tầng đám mây và chốt số máy chủ.
