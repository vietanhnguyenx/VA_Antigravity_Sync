...
| 2 | Định dạng dữ liệu Lufthansa Systems yêu cầu cho từng luồng (kể cả mẫu điện FFM mà TOSS phải tự sinh). | Cần định dạng chuẩn để TOSS sinh đúng tệp tin và truyền qua SFTP. | VNA làm việc với Lufthansa Systems, gửi tài liệu định dạng cho Viettel xem trước. |
