...
| KS-90 | **Mốc thời gian gửi và đồng bộ dữ liệu cho từng luồng inbound/outbound**, kèm thời gian lưu trữ trên SFTP và thời điểm xoá tệp — quyết định kiến trúc lưu trữ và lịch chạy tác vụ TOSS. | KS 19/06 §IV-4; KS 23/06 §II.7–9, §III-8…10 | VNA làm việc tiếp với LHS | 🟡 Đang xử lý | **23/06: bảng tích hợp có cột Frequency một phần; nhiều ô vẫn "Làm rõ". Đã chốt thêm các tần suất cụ thể từ KS 23/06: PTM = 5 phút/lần trong cửa sổ 48h trước cất cánh, gửi khi có cập nhật (§II.7, §III-8); PNL = 1 lần tại T-30 (§II.8, §III-9); ADL = 1 lần/ngày đến gần ngày bay, ~30 phút/lần trong ngày bay (§II.8, §III-9); Crew Assignment = initial 02:00 ngày 26 hàng tháng cho tháng kế tiếp, retry 23:59 cùng ngày, cảnh báo khi <1000 chuyến có dữ liệu (§II.9, §III-10); SSIM = forward khi Sabre sinh tệp mới, 3 lần/ngày (§II.6); Pax Detail = sau khi chốt boarding mỗi chuyến (§II.8). Các luồng khác vẫn pending.** |
