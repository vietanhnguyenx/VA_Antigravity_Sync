...
│ ║ │ [Sơ đồ sân bay — hiển thị vị trí bay đỗ A07]                        │ ║     │
│ ║ └────────────────────────────────────────────────────────────────────┘ ║     │
│ ║                                                                            ║     │
│ ║ ┌─ Boarding Gate & Giờ boarding (MM626/627) ─────────────────────────┐ ║     │
│ ║ │ Gate: 22A    Boarding Time: 08:50    Trạng thái boarding: 🟢 Open │ ║     │
...
│ ║ │ Bay đỗ dự kiến: B12     Terminal: T1     Còn cách giờ đến: 18 phút │ ║     │
│ ║ └────────────────────────────────────────────────────────────────────┘ ║     │
│ ║                                                                            ║     │
...
│ ╚════════════════════════════════════════════════════════════════════════════╝   │
│                                                                                    │
│ ╔════════════════ Khuyến nghị · NOTAM & Thời tiết · Nhiên liệu ══════════╗      │
│ ║                                                                            ║     │
...
│ ║ │ ...                                                                 │ ║     │
│ ║ │ (Click 1 NOTAM → modal nội dung raw + bản dịch)                    │ ║     │
...
*Wireframe v0.2 — phủ đầy đủ 14 MM nhóm 3 (Airport).*
*v0.2 (2026-06-11): đồng bộ theo bản chỉnh sửa `wf-flight-detail-airport.drawio` — đổi nhãn "Boarding hiện trạng"→"Trạng thái boarding", "Cách bay đến"→"Còn cách giờ đến"; tiêu đề khối 3 → "Khuyến nghị · NOTAM & Thời tiết · Nhiên liệu"; tab "W&F" viết đầy đủ "Weight & Fuel"; placeholder sơ đồ sân bay ghi rõ "vị trí bay đỗ A07"; thêm ghi chú click-NOTAM-mở-modal vào trong khối NOTAM; định dạng số nhiên liệu theo kiểu Việt (9.800 / 1.200 / 13.190).*
