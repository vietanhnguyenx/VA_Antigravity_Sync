# INDEX — Đặc tả chức năng: Phân rã BRD → FUNC (per phân hệ)

> Đọc index này trước rồi mở đúng phân hệ cần (rule: đọc chọn lọc, không nạp cả thư mục).
...
| `PHAN-RA-BRD-PH5-quan-tri-he-thong-v0.3.md` | 466 | **PH5** — Quản trị hệ thống *(chờ BRD PH5 v0.5 freeze — G2)* |
