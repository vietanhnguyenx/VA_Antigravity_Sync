...
* **Đầu việc SRS:** Công thức tính suất trung bình luỹ kế của chặng/tàu.
...
1. **Bước 1: Thiết kế giao diện nháp (Mockup)**
   * Dựa vào ảnh thiết kế giao diện **Web EFF** hiện tại để thiết kế thêm Tab "Nước sạch" bên khu phải.
