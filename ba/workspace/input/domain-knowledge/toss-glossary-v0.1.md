...
| **e-FON** (Electronic Flight Operations Notice) | Thông báo Khai thác Bay Điện tử | Hệ thống điện tử hóa kênh thông báo khai thác bay [FON](#f) của VNA. Dự kiến triển khai sau TOSS; nhận dữ liệu MEL/CDL từ TOSS (TOSS là đầu mối tích hợp [AMOS](#a), e-FON không cần tự tích hợp AMOS riêng). Chi tiết giao diện TOSS ↔ e-FON sẽ được xác định khi e-FON bước vào giai đoạn triển khai (chưa có hợp đồng). *(Trong transcript 17/06 ASR ghi nhiều dạng: "FOIE", "FOI", "FOEM", "FOM" — đều là lỗi nhận dạng của "e-FON". BA Lead xác nhận 17/06/2026.)* (nguồn: KS 17/06/2026 §1.) |
...
| **FON** (Flight Operations Notice) | Thông báo Khai thác Bay | Kênh thông báo/cập nhật thông tin khai thác cho điều phái, truy cập trong EFB: extra fuel/taxi fuel/holding fuel, performance factor, cost index, thông tin khai thác khác (nguồn: FDOP §3.1 — "refer to FON in EFB"). Phiên bản điện tử hóa của FON là hệ thống [e-FON](#e). *(Tên đầy đủ đã xác nhận: Flight Operations Notice — BA Lead 17/06/2026.)* |
