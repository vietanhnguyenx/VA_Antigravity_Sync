...
| `Aircraft_FIMS.xlsx` | **Master tàu bay — nguồn FIMS** (cấu hình khoang/ghế, MTOW, payload, tank, ICAO/model…). | `drafts/phan-tich/customer-docs-source/Aircraft_FIMS.extracted.md` → PH4 |
| `Aircraft_Netline.xlsx` | **Master tàu bay — nguồn Netline** (operator/owner, hiệu lực lịch sử, DOW, thiết bị ILS/autoland, AP_restriction…). | `drafts/phan-tich/customer-docs-source/Aircraft_Netline.extracted.md` → PH4 |
